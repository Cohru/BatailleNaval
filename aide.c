...
#include"menu.h"
void aide(){
    printf("AIDE POUR JOUER COMME UN PRO !\n ");
    ...
    printf("- une deuxième grille pour visualiser les degats causes à l'adversaire\n");
    ...
    printf("Chaque joueur joue à chaque tour de role, en choisissant a chaque tour une des trois actions:");
